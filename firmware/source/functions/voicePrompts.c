...
/**
 * \brief Data header for voice prompts
 */
typedef struct {
	uint32_t magic;
	uint32_t version;
...
/**
 * \brief The AMBE data buffer size
 *
 * \note The default value for this buffer is \b 2052 bytes; this holds \b 76 AMBE frames, each of which is \b 27 bytes.
 */
