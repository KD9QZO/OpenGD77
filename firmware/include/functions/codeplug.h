...
enum CONTACT_CALLTYPE_SELECT {
	CONTACT_CALLTYPE_TG = 0, CONTACT_CALLTYPE_PC, CONTACT_CALLTYPE_ALL
};

typedef enum {
	CHANNEL_VFO_A = 0, CHANNEL_VFO_B, CHANNEL_CHANNEL
} Channel_t;
...
typedef struct {
	char radioName[8]; /*!< Call Sign */
	uint32_t radioId; /*!< DMR ID */
...
typedef enum {
	CODEPLUG_CUSTOM_DATA_TYPE_NONE = 0, CODEPLUG_CUSTOM_DATA_TYPE_IMAGE, CODEPLUG_CUSTOM_DATA_TYPE_BEEP
